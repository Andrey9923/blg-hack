...
The unit persists runs to `results/operator.sqlite3` and has no login screen.
The provided Nginx configuration starts with HTTP only; Certbot below adds TLS.
SQLite serializes writes, and calculations remain synchronous.
